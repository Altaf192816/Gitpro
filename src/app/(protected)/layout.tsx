    ...
    <SidebarProvider>
      ...
      <main className="m-2 w-full">
        <div className="border-sidebar-border bg-sidebar flex items-center gap-2 rounded-md border px-4 py-2 shadow">
          ...
          <Button title="Explore with git-pro" size={"sm"}>
            <a href="https://precious-duckanoo-206c00.netlify.app" target="_blank" className="min-w-fit">Explore</a>
          </Button>
          <UserButton />
        </div>
        <div className="h-4"></div>
        <div className="border-sidebar-border bg-sidebar h-[calc(100dvh-5.3rem)] overflow-y-auto rounded-md border p-4 shadow">
          {children}
        </div>
      </main>
    </SidebarProvider>
